...
{				?>	
										<tr>
                                            ...
                                            <td><?php echo htmlentities($result->cgpar);?></td>
											...
											<td><?php echo htmlentities($result->noofstudent);?></td>
											<td>
...
<td>
<a href="../email/index.php?cname=<?php echo $result->company_name; ?>" class="btn btn-primary"  >Send</a>

<!--<button class="btn btn-primary" type="button" src="email/index.php">send</button>
<a href="email/index.php" onclick="tasks();">&nbsp; <i class="fa fa-paper-plane"></i></a>&nbsp;&nbsp;-->
</td>
